...
public class SepConsumer extends BaseHRegionServer {
    ...
    public SepConsumer(String subscriptionId, long subscriptionTimestamp, EventListener listener, int threadCnt,
        ...
        log.info("rpc port=" + rpcServer.getListenerAddress().getPort());
    ...
    private List<RpcServer.BlockingServiceAndInterface> getServices() {
        ...
        bssi.add(new RpcServer.BlockingServiceAndInterface(
                org.apache.hadoop.hbase.shaded.protobuf.generated.AdminProtos.AdminService.newReflectiveBlockingService(this),
    ...
    @Override
    public org.apache.hadoop.hbase.shaded.protobuf.generated.AdminProtos.ReplicateWALEntryResponse replicateWALEntry(org.apache.hbase.thirdparty.com.google.protobuf.RpcController rpcController, org.apache.hadoop.hbase.shaded.protobuf.generated.AdminProtos.ReplicateWALEntryRequest replicateWALEntryRequest) {
        try {
            long lastProcessedTimestamp = -1;

            SepEventExecutor eventExecutor = new SepEventExecutor(listener, executors, 100, sepMetrics);

            List<org.apache.hadoop.hbase.shaded.protobuf.generated.AdminProtos.WALEntry> entries = replicateWALEntryRequest.getEntryList();
            CellScanner cells = ((HBaseRpcController) rpcController).cellScanner();

            for (final org.apache.hadoop.hbase.shaded.protobuf.generated.AdminProtos.WALEntry entry : entries) {
            ...
            return org.apache.hadoop.hbase.shaded.protobuf.generated.AdminProtos.ReplicateWALEntryResponse.newBuilder().build();
